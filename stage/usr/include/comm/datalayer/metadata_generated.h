...
struct Extension FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool KeyCompareLessThan(const Extension * const o) const {
    return *key() < *o->key();
  }
...
struct LocaleText FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool KeyCompareLessThan(const LocaleText * const o) const {
    return *id() < *o->id();
  }
...
struct Reference FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool KeyCompareLessThan(const Reference * const o) const {
    return *type() < *o->type();
  }
...
struct Metadata FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_nodeClass(comm::datalayer::NodeClass _nodeClass = static_cast<comm::datalayer::NodeClass>(0)) {
  ...
  bool mutate_displayFormat(comm::datalayer::DisplayFormat _displayFormat = static_cast<comm::datalayer::DisplayFormat>(0)) {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int8_t>(verifier, VT_NODECLASS, 1) &&
           ...
           VerifyField<int8_t>(verifier, VT_DISPLAYFORMAT, 1) &&
...
inline MetadataT::MetadataT(const MetadataT &o)
      : nodeClass(o.nodeClass),
        operations((o.operations) ? new comm::datalayer::AllowedOperationsT(*o.operations) : nullptr),
  ...
  for (const auto &extensions_ : o.extensions) { extensions.emplace_back((extensions_) ? new comm::datalayer::ExtensionT(*extensions_) : nullptr); }
  references.reserve(o.references.size());
  for (const auto &references_ : o.references) { references.emplace_back((references_) ? new comm::datalayer::ReferenceT(*references_) : nullptr); }
  descriptions.reserve(o.descriptions.size());
  for (const auto &descriptions_ : o.descriptions) { descriptions.emplace_back((descriptions_) ? new comm::datalayer::LocaleTextT(*descriptions_) : nullptr); }
  displayNames.reserve(o.displayNames.size());
  for (const auto &displayNames_ : o.displayNames) { displayNames.emplace_back((displayNames_) ? new comm::datalayer::LocaleTextT(*displayNames_) : nullptr); }
}

inline MetadataT &MetadataT::operator=(MetadataT o) FLATBUFFERS_NOEXCEPT {
  std::swap(nodeClass, o.nodeClass);
  std::swap(operations, o.operations);
  std::swap(description, o.description);
  std::swap(descriptionUrl, o.descriptionUrl);
  std::swap(displayName, o.displayName);
  std::swap(displayFormat, o.displayFormat);
  std::swap(unit, o.unit);
  std::swap(extensions, o.extensions);
  std::swap(references, o.references);
  std::swap(descriptions, o.descriptions);
  std::swap(displayNames, o.displayNames);
  return *this;
}
...
inline void Metadata::UnPackTo(MetadataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = operations(); if (_e) { if(_o->operations) { _e->UnPackTo(_o->operations.get(), _resolver); } else { _o->operations = std::unique_ptr<comm::datalayer::AllowedOperationsT>(_e->UnPack(_resolver)); } } else if (_o->operations) { _o->operations.reset(); } }
  ...
  { auto _e = extensions(); if (_e) { _o->extensions.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->extensions[_i]) { _e->Get(_i)->UnPackTo(_o->extensions[_i].get(), _resolver); } else { _o->extensions[_i] = std::unique_ptr<comm::datalayer::ExtensionT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->extensions.resize(0); } }
  { auto _e = references(); if (_e) { _o->references.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->references[_i]) { _e->Get(_i)->UnPackTo(_o->references[_i].get(), _resolver); } else { _o->references[_i] = std::unique_ptr<comm::datalayer::ReferenceT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->references.resize(0); } }
  { auto _e = descriptions(); if (_e) { _o->descriptions.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->descriptions[_i]) { _e->Get(_i)->UnPackTo(_o->descriptions[_i].get(), _resolver); } else { _o->descriptions[_i] = std::unique_ptr<comm::datalayer::LocaleTextT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->descriptions.resize(0); } }
  { auto _e = displayNames(); if (_e) { _o->displayNames.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->displayNames[_i]) { _e->Get(_i)->UnPackTo(_o->displayNames[_i].get(), _resolver); } else { _o->displayNames[_i] = std::unique_ptr<comm::datalayer::LocaleTextT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->displayNames.resize(0); } }
}
...
inline comm::datalayer::Metadata *GetMutableSizePrefixedMetadata(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::Metadata>(buf);
}
