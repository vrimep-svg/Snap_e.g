...
struct ScopesT : public ::flatbuffers::NativeTable {
  ...
  ScopesT() = default;
  ScopesT(const ScopesT &o);
  ScopesT(ScopesT&&) FLATBUFFERS_NOEXCEPT = default;
  ScopesT &operator=(ScopesT o) FLATBUFFERS_NOEXCEPT;
};
...
inline ScopesT::ScopesT(const ScopesT &o) {
...
inline ScopesT &ScopesT::operator=(ScopesT o) FLATBUFFERS_NOEXCEPT {
...
inline comm::datalayer::Scopes *GetMutableSizePrefixedScopes(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::Scopes>(buf);
}
