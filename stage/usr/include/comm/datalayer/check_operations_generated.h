...
inline comm::datalayer::CheckOperations *GetMutableSizePrefixedCheckOperations(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::CheckOperations>(buf);
}
