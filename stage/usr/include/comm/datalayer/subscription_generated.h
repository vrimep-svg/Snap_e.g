...
inline comm::datalayer::Subscription *GetMutableSizePrefixedSubscription(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::Subscription>(buf);
}
