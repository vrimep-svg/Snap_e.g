...
inline comm::datalayer::ArrayOfInt8 *GetMutableSizePrefixedArrayOfInt8(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::ArrayOfInt8>(buf);
}
