...
inline comm::datalayer::ArrayOfUInt64 *GetMutableSizePrefixedArrayOfUInt64(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::ArrayOfUInt64>(buf);
}
