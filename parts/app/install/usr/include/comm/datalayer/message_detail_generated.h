...
inline comm::datalayer::MessageDetail *GetMutableSizePrefixedMessageDetail(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::MessageDetail>(buf);
}
