...
struct FactoryStats FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_numClients(uint32_t _numClients = 0) {
  ...
  bool mutate_numProviders(uint32_t _numProviders = 0) {
  ...
  bool mutate_openClientRequests(uint32_t _openClientRequests = 0) {
  ...
  bool mutate_openProviderRequests(uint32_t _openProviderRequests = 0) {
    return SetField<uint32_t>(VT_OPENPROVIDERREQUESTS, _openProviderRequests, 0);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_NUMCLIENTS, 4) &&
           VerifyField<uint32_t>(verifier, VT_NUMPROVIDERS, 4) &&
           VerifyField<uint32_t>(verifier, VT_OPENCLIENTREQUESTS, 4) &&
           VerifyField<uint32_t>(verifier, VT_OPENPROVIDERREQUESTS, 4) &&
           verifier.EndTable();
  }
...
inline comm::datalayer::FactoryStats *GetMutableSizePrefixedFactoryStats(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::FactoryStats>(buf);
}
