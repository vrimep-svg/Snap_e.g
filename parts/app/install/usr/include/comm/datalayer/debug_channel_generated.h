...
struct DebugChannel FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_isTrigger(bool _isTrigger = 0) {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_ISTRIGGER, 1) &&
           verifier.EndTable();
  }
...
inline comm::datalayer::DebugChannel *GetMutableSizePrefixedDebugChannel(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::DebugChannel>(buf);
}
