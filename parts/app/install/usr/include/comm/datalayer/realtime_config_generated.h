...
struct RealtimeConfigT : public ::flatbuffers::NativeTable {
  ...
  comm::datalayer::AccessType defaultInputAcessType = comm::datalayer::AccessType_NTelBuf;
...
struct RealtimeConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  comm::datalayer::AccessType defaultInputAcessType() const {
    return static_cast<comm::datalayer::AccessType>(GetField<int8_t>(VT_DEFAULTINPUTACESSTYPE, 3));
  }
  bool mutate_defaultInputAcessType(comm::datalayer::AccessType _defaultInputAcessType = static_cast<comm::datalayer::AccessType>(3)) {
    return SetField<int8_t>(VT_DEFAULTINPUTACESSTYPE, static_cast<int8_t>(_defaultInputAcessType), 3);
  }
...
struct RealtimeConfigBuilder {
  ...
  void add_defaultInputAcessType(comm::datalayer::AccessType defaultInputAcessType) {
    fbb_.AddElement<int8_t>(RealtimeConfig::VT_DEFAULTINPUTACESSTYPE, static_cast<int8_t>(defaultInputAcessType), 3);
  }
