...
struct SubscriptionDataT : public ::flatbuffers::NativeTable {
  ...
  SubscriptionDataT() = default;
  SubscriptionDataT(const SubscriptionDataT &o);
  SubscriptionDataT(SubscriptionDataT&&) FLATBUFFERS_NOEXCEPT = default;
  SubscriptionDataT &operator=(SubscriptionDataT o) FLATBUFFERS_NOEXCEPT;
};
...
inline SubscriptionDataT::SubscriptionDataT(const SubscriptionDataT &o)
      : properties((o.properties) ? new comm::datalayer::SubscriptionPropertiesT(*o.properties) : nullptr),
        nodes(o.nodes) {
}

inline SubscriptionDataT &SubscriptionDataT::operator=(SubscriptionDataT o) FLATBUFFERS_NOEXCEPT {
...
inline void SubscriptionData::UnPackTo(SubscriptionDataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = properties(); if (_e) { if(_o->properties) { _e->UnPackTo(_o->properties.get(), _resolver); } else { _o->properties = std::unique_ptr<comm::datalayer::SubscriptionPropertiesT>(_e->UnPack(_resolver)); } } else if (_o->properties) { _o->properties.reset(); } }
...
inline comm::datalayer::SubscriptionData *GetMutableSizePrefixedSubscriptionData(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::SubscriptionData>(buf);
}
