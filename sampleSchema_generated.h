...
struct TimeObserver FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int64_t offset_ms() const {
    return GetField<int64_t>(VT_OFFSET_MS, 0);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int64_t>(verifier, VT_OFFSET_MS, 8) &&
...
struct TimeObserverBuilder {
  ...
  void add_offset_ms(int64_t offset_ms) {
    fbb_.AddElement<int64_t>(TimeObserver::VT_OFFSET_MS, offset_ms, 0);
  }
  ...
  void add_statuscode(int64_t statuscode) {
    fbb_.AddElement<int64_t>(TimeObserver::VT_STATUSCODE, statuscode, 0);
  }
...
inline ::flatbuffers::Offset<TimeObserver> CreateTimeObserver(
  ...
  builder_.add_offset_ms(offset_ms);
...
inline void TimeObserver::UnPackTo(TimeObserverT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = offset_ms(); _o->offset_ms = _e; }
