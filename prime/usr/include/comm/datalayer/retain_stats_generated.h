...
#include "retain_diagnosis_generated.h"
...
struct RetainStatsT : public ::flatbuffers::NativeTable {
  ...
  uint32_t lastUsed = 0;
  std::string info{};
  std::unique_ptr<comm::datalayer::RetainDiagnosisT> diagnosis{};
  RetainStatsT() = default;
  RetainStatsT(const RetainStatsT &o);
  RetainStatsT(RetainStatsT&&) FLATBUFFERS_NOEXCEPT = default;
  RetainStatsT &operator=(RetainStatsT o) FLATBUFFERS_NOEXCEPT;
};
...
struct RetainStats FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_total(uint32_t _total = 0) {
  ...
  bool mutate_free(uint32_t _free = 0) {
  ...
  bool mutate_used(uint32_t _used = 0) {
  ...
  bool mutate_biggestFree(uint32_t _biggestFree = 0) {
  ...
  bool mutate_syncCounter(uint32_t _syncCounter = 0) {
  ...
  bool mutate_lastUsed(uint32_t _lastUsed = 0) {
  ...
  /// diagnosis of nvram
  const comm::datalayer::RetainDiagnosis *diagnosis() const {
    return GetPointer<const comm::datalayer::RetainDiagnosis *>(VT_DIAGNOSIS);
  }
  comm::datalayer::RetainDiagnosis *mutable_diagnosis() {
    return GetPointer<comm::datalayer::RetainDiagnosis *>(VT_DIAGNOSIS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_TOTAL, 4) &&
           VerifyField<uint32_t>(verifier, VT_FREE, 4) &&
           VerifyField<uint32_t>(verifier, VT_USED, 4) &&
           VerifyField<uint32_t>(verifier, VT_BIGGESTFREE, 4) &&
           VerifyField<uint32_t>(verifier, VT_SYNCCOUNTER, 4) &&
           VerifyField<uint32_t>(verifier, VT_LASTUSED, 4) &&
           VerifyOffset(verifier, VT_INFO) &&
           verifier.VerifyString(info()) &&
           VerifyOffset(verifier, VT_DIAGNOSIS) &&
           verifier.VerifyTable(diagnosis()) &&
           verifier.EndTable();
  }
...
struct RetainStatsBuilder {
  ...
  void add_diagnosis(::flatbuffers::Offset<comm::datalayer::RetainDiagnosis> diagnosis) {
    fbb_.AddOffset(RetainStats::VT_DIAGNOSIS, diagnosis);
  }
...
inline ::flatbuffers::Offset<RetainStats> CreateRetainStats(
    ...
    ::flatbuffers::Offset<comm::datalayer::RetainDiagnosis> diagnosis = 0) {
  RetainStatsBuilder builder_(_fbb);
  builder_.add_diagnosis(diagnosis);
...
inline RetainStatsT::RetainStatsT(const RetainStatsT &o)
      : total(o.total),
        free(o.free),
        used(o.used),
        biggestFree(o.biggestFree),
        syncCounter(o.syncCounter),
        lastUsed(o.lastUsed),
        info(o.info),
        diagnosis((o.diagnosis) ? new comm::datalayer::RetainDiagnosisT(*o.diagnosis) : nullptr) {
}

inline RetainStatsT &RetainStatsT::operator=(RetainStatsT o) FLATBUFFERS_NOEXCEPT {
  std::swap(total, o.total);
  std::swap(free, o.free);
  std::swap(used, o.used);
  std::swap(biggestFree, o.biggestFree);
  std::swap(syncCounter, o.syncCounter);
  std::swap(lastUsed, o.lastUsed);
  std::swap(info, o.info);
  std::swap(diagnosis, o.diagnosis);
  return *this;
}
...
inline void RetainStats::UnPackTo(RetainStatsT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = diagnosis(); if (_e) { if(_o->diagnosis) { _e->UnPackTo(_o->diagnosis.get(), _resolver); } else { _o->diagnosis = std::unique_ptr<comm::datalayer::RetainDiagnosisT>(_e->UnPack(_resolver)); } } else if (_o->diagnosis) { _o->diagnosis.reset(); } }
}
...
inline ::flatbuffers::Offset<RetainStats> CreateRetainStats(::flatbuffers::FlatBufferBuilder &_fbb, const RetainStatsT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _diagnosis = _o->diagnosis ? CreateRetainDiagnosis(_fbb, _o->diagnosis.get(), _rehasher) : 0;
  return comm::datalayer::CreateRetainStats(
      _fbb,
      _total,
      _free,
...
inline comm::datalayer::RetainStats *GetMutableSizePrefixedRetainStats(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::RetainStats>(buf);
}
