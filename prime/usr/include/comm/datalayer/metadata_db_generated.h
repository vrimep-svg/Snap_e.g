...
struct MetadataDB FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *mutable_scopes() {
    return GetPointer<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_SCOPES);
  }
...
struct MetadataDBBuilder {
  ...
  void add_scopes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> scopes) {
    fbb_.AddOffset(MetadataDB::VT_SCOPES, scopes);
  }
...
inline void MetadataDB::UnPackTo(MetadataDBT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = scopes(); if (_e) { _o->scopes.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->scopes[_i] = _e->Get(_i)->str(); } } else { _o->scopes.resize(0); } }
}
...
inline ::flatbuffers::Offset<MetadataDB> CreateMetadataDB(::flatbuffers::FlatBufferBuilder &_fbb, const MetadataDBT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _scopes = _o->scopes.size() ? _fbb.CreateVectorOfStrings(_o->scopes) : 0;
  return comm::datalayer::CreateMetadataDB(
      _fbb,
      _address,
      _childs,
