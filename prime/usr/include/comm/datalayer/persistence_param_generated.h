...
inline comm::datalayer::PersistenceParam *GetMutableSizePrefixedPersistenceParam(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::PersistenceParam>(buf);
}
