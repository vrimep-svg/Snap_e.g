...
struct SubscriptionSettings FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_minimumPublishInterval(uint32_t _minimumPublishInterval = 50) {
  ...
  bool mutate_minimumSampleInterval(uint64_t _minimumSampleInterval = 100000ULL) {
  ...
  bool mutate_maximumBufferSize(uint32_t _maximumBufferSize = 50) {
  ...
  bool mutate_minimumErrorInterval(uint32_t _minimumErrorInterval = 10000) {
  ...
  bool mutate_maximumRTSubscribedNodes(uint32_t _maximumRTSubscribedNodes = 50) {
    return SetField<uint32_t>(VT_MAXIMUMRTSUBSCRIBEDNODES, _maximumRTSubscribedNodes, 50);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_MINIMUMPUBLISHINTERVAL, 4) &&
           VerifyField<uint64_t>(verifier, VT_MINIMUMSAMPLEINTERVAL, 8) &&
           VerifyField<uint32_t>(verifier, VT_MAXIMUMBUFFERSIZE, 4) &&
           VerifyField<uint32_t>(verifier, VT_MINIMUMERRORINTERVAL, 4) &&
           VerifyField<uint32_t>(verifier, VT_MAXIMUMRTSUBSCRIBEDNODES, 4) &&
           verifier.EndTable();
  }
...
inline comm::datalayer::SubscriptionSettings *GetMutableSizePrefixedSubscriptionSettings(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::SubscriptionSettings>(buf);
}
