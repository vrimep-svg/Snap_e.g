...
extern "C" {
  ...
  //! @param[in]  provider  Reference to the provider
  //! @param[out] data      Variant which includes the rejected node paths after this function
  //! @return status of the function call
  ...
  //! @result status of function call
  DLR_RESULT DLR_providerPublishEvent(DLR_PROVIDER provider, const DLR_VARIANT data, const DLR_VARIANT eventInfo);
