...
inline void ArrayOfBool8::UnPackTo(ArrayOfBool8T *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = value(); if (_e) { _o->value.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->value[_i] = _e->Get(_i) != 0; } } else { _o->value.resize(0); } }
}
...
inline comm::datalayer::ArrayOfBool8 *GetMutableSizePrefixedArrayOfBool8(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<comm::datalayer::ArrayOfBool8>(buf);
}
